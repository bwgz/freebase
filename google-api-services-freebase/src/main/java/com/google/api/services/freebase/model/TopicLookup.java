...
public final class TopicLookup extends GenericJson {
   ...
   */
  public TopicLookup setId(String id) {
    this.id = id;
    return this;
  }
   ...
   * The value set may be {@code null}.
   */
  public TopicLookup setProperty(Property property) {
   ...
   */
  public static final class Property extends GenericJson {
