...
public final class TopicLookup extends com.google.api.client.json.GenericJson {
   ...
   */
  public TopicLookup setId(java.lang.String id) {
    this.id = id;
    return this;
  }
  ...
  @Override
  public TopicLookup set(String fieldName, Object value) {
    return (TopicLookup) super.set(fieldName, value);
  }

  @Override
  public TopicLookup clone() {
